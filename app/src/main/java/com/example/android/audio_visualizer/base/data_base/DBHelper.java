...
import com.example.android.audio_visualizer.base.data_base.AudioVisualizerContract.Audio;
import com.example.android.audio_visualizer.base.data_base.AudioVisualizerContract.Picture;
import com.example.android.audio_visualizer.base.data_base.AudioVisualizerContract.Audio_Picture;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        final String SQL_CREATE_AUDIO = "CREATE TABLE " + Audio.Table_Name
                ...
                + Audio.Column_Duration + " TEXT NOT NULL "
                + ")";
